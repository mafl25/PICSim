...
uint64_t get_substring(const void *self, void *substring, uint64_t pos);
uint64_t get_substring_in_line(const void *self, void *substring, uint64_t pos);
...
int64_t string_to_hex(const void *self);
