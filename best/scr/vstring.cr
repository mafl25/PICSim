...
struct vstring_vtable
{
	...
	uint64_t (*vstring_get_substring)(const void *self, void *substring, uint64_t pos);
	uint64_t (*vstring_get_substring_in_line)(const void *self, void *substring, uint64_t pos);
	...
	int64_t (*vstring_string_to_hex)(const void *self);
	void *(*vstring_hex_to_string)(void *self, uint64_t number);
};

void *vstring_constructor(void *self, va_list *pa);
void *vstring_clone(const void *self);
