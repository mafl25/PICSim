...
SOURCES = main.c outputbuffer.c filedialog.c filemanager.c commoncallbacks.c settings.c customstring.c datastructure.c menubar.c toolbar.c variabletreeview.c
OBJECTS = $(SOURCES:.c=.o)
